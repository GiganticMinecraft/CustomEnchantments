...
public class Stomp extends CEnchantment {
            ...
            if (!entities.isEmpty()) {
              for (Entity ent : entities) {
                if (ent instanceof LivingEntity) {
                  ((LivingEntity) ent).damage(event.getDamage() / damageApplicationFraction,
                      player);
  ...
  public void initConfigEntries() {
    damageReductionFraction = Integer.parseInt(
        getConfig().getString("Enchantments." + getOriginalName() + ".DamageReductionFraction"));
    damageApplicationFraction = Integer.parseInt(
        getConfig().getString("Enchantments." + getOriginalName() + ".DamageApplicationFraction"));
  }
}
