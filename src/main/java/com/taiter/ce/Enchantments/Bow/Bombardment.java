...
public class Bombardment extends CEnchantment {
  ...
  public void effect(Event e, ItemStack item, final int level) {
    if (e instanceof EntityDamageByEntityEvent) {
      ...
      Location spawnLocation = new Location(world, target.getLocation().getX(), 255,
  ...
  public void initConfigEntries() {
    Volume = Integer.parseInt(
        getConfig().getString("Enchantments." + getOriginalName() + ".Volume"));
    TNTAmount = Integer.parseInt(
        getConfig().getString("Enchantments." + getOriginalName() + ".BaseTNTAmount"));
  }
