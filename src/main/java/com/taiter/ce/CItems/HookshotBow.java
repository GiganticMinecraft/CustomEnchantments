...
public class HookshotBow extends CItem {
  ...
  public HookshotBow(String originalName, ChatColor color, String lDescription, long lCooldown,
      Material mat) {
  ...
  public boolean effect(Event event, Player player) {
    if (event instanceof PlayerInteractEvent) {
      ...
      e.getProjectile().setMetadata("ce." + getOriginalName(), new FixedMetadataValue(main,
          ChatColor.stripColor(lore.get(lore.size() - 1)).split(": ")[1]));
