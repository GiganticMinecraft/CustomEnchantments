...
public class Landmine extends CItem {
  ...
  public Landmine(String originalName, ChatColor color, String lDescription, long lCooldown,
      Material mat) {
  ...
  public boolean effect(Event event, Player player) {
    if (event instanceof BlockPlaceEvent) {
      ...
      if (!b.getType().equals(Material.AIR) && !b.getType().equals(Material.WATER) && !b.getType()
          .equals(Material.LAVA) && Tools.checkWorldGuard(loc, player, "PVP", false)) {
  ...
  public void initConfigEntries() {
    ExplosionStrength = Integer.parseInt(
        getConfig().getString("Items." + getOriginalName() + ".ExplosionStrength"));
  }
