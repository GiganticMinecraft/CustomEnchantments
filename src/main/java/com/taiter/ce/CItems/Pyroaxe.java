...
public class Pyroaxe extends CItem {
  ...
  public Pyroaxe(String originalName, ChatColor color, String lDescription, long lCooldown,
      Material mat) {
  ...
  public void initConfigEntries() {
    damageMultiplier = Integer.parseInt(
        Main.config.getString("Items." + getOriginalName() + ".DamageMultiplier"));
  }
