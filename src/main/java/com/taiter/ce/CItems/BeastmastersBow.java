...
//	String placeHolder = ChatColor.GRAY + "" + ChatColor.ITALIC + "    None";
  ...
  public BeastmastersBow(String originalName, ChatColor color, String lDescription, long lCooldown,
      Material mat) {
...
//			  e.getProjectile().setMetadata("ce." + this.getOriginalName(), null);
    if (event instanceof EntityDamageByEntityEvent) {
      ...
      if (ent instanceof Silverfish || ent instanceof EnderDragon || ent instanceof Spider
          || ent instanceof Slime || ent instanceof Ghast || ent instanceof MagmaCube
          || ent instanceof CaveSpider || (ent instanceof Wolf && ((Wolf) ent).isAngry())
...
//		MaximumMobStorage = Integer.parseInt(getConfig().getString("Items." + getOriginalName() + ".MaximumMobStorage"));
    MaximumMobs = Integer.parseInt(
        getConfig().getString("Items." + getOriginalName() + ".MaximumMobs"));
    MobAppearanceChance = Integer.parseInt(
        getConfig().getString("Items." + getOriginalName() + ".MobAppearanceChance"));
    DamageMultiplication = Integer.parseInt(
        getConfig().getString("Items." + getOriginalName() + ".DamageMultiplication"));
  }
