...
public class Medikit extends CItem {
  ...
  public Medikit(String originalName, ChatColor color, String lDescription, long lCooldown,
      Material mat) {
    ...
    if (event instanceof PlayerInteractEvent) {
      ...
      if (toHeal != null) {
        ...
        if (toHeal.getHealth() != maxHealth) {
          ...
          player.sendMessage(
              ChatColor.GREEN + "You have healed " + toHeal.getName() + " using the Medikit!");
          toHeal.sendMessage(
              ChatColor.GREEN + player.getName() + " has used a Medikit to heal you!");
          return true;
        } else {
          player.sendMessage(
              ChatColor.RED + "Your target does not have any wounds to apply the Medikit to!");
        }
  ...
  public void initConfigEntries() {
    HealAmount = Integer.parseInt(
        getConfig().getString("Items." + getOriginalName() + ".HealAmount"));
  }
